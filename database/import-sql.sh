...
#
# SQL IMPORT DATABASES IF PRESENT

# Import provided SQL files in to MySQL.
#
# The files in the /database/backups/ directory should be created by
...
# `db_name` matches the name of a database already created /database/init.sql.
#
